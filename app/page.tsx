...
export default function Home() {
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      setProgress(100);
      setMessage("Invoice uploaded securely. Choose a scenario below to walk through verification.");
    } catch (error) {
      setUploadState("error");
  ...
  return (
    <main className="min-h-screen bg-[#06111f] text-white">
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-8 lg:px-10">
        ...
        <footer className="border-t border-white/10 pt-5 text-xs text-slate-600">Trusted Supplier Verification · Secure invoice intake · Synthetic invoice data</footer>
      </div>
    </main>
  );
}
